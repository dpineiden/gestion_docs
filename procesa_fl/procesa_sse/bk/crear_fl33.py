...
Salida='salida/'+OUT_FOLDER+'/FL33_'+Codigo_Proyecto+'_'+Fecha_Solicita+'_NoSSE_'+No_solicitud+'.odt'
...
for i in range(0,N_labs):
 ...
 if len(Data_R08[i]['datos'])>0 :
  ...
  Salida_R08='salida/'+OUT_FOLDER+'/R08_'+LAB_Data_R08['lab']+'_'+Codigo_Proyecto+'_'+Fecha_Solicita+'_NoSSE_'+No_solicitud+'.ods'
